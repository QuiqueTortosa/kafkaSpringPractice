...
import com.toxxii.reactivekafkaplayground.errorHandling.sec12.ReactiveDeadLetterTopicProducer;
...
public class TransferDemo {
    ...
    public static void main(String[] args) {
        ...
        transferEventConsumer
                ...
                .doOnNext(r -> log.info("transfer succes: {}", r.correlationMetadata()))
    ...
    private static KafkaSender<String, String> kafkaSender() {
        var producerConfig = Map.<String, Object>of(
                ...
                ProducerConfig.TRANSACTIONAL_ID_CONFIG,"money-transfer" //id
        );
